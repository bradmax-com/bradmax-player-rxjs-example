...
import BradmaxPlayerGorilla from '@bradmax/player-rxjs/gorilla';
import BradmaxPlayerMole from '@bradmax/player-rxjs/mole';
import BradmaxPlayerSnake from '@bradmax/player-rxjs/snake';
import BradmaxPlayerZebra from '@bradmax/player-rxjs/zebra';
